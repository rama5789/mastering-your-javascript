...

{
    log(tag, 'function_definitions');
    {
        ...
        function myFn(a, b, c) {    // function definition | declaration
        ...
        console.log('Object.prototype.toString.call(myFn): ', Object.prototype.toString.call(myFn));    // [object Function]

        // instanceof
        console.log('myFn instanceof [Number, Array]: ', myFn instanceof Number, myFn instanceof Array); // false false
        console.log('myFn instanceof [Object, Function]: ', myFn instanceof Object, myFn instanceof Function);    // true true
        console.log('myFn.constructor === [Object, Function]: ', myFn.constructor === Object, myFn.constructor === Function);  // false true
        console.log('Function.constructor === [Object, Function]: ', Function.constructor === Object, Function.constructor === Function); // false true
    };
...

{
    ...
    ((a, b) => {    // anonymous arrow function
        const x = a + b;
        console.log('x: ', x);  // 10
    })(4, 6);

    (function namedIIFE() { // named function
...

    {
...

        {
            ...
            const incrementCounter = (function () { // IIFE
...

{
    log(tag, 'function_parameters');
    {
        ...
        function myFn2(a, b = 4) {  // default param
            return a + b;
        }
...

    {
        ...
        function myFn(multiplier, ...args) {    // rest params
...

{
    ...
    function myFn(a, b, c) {    // un-curried function
        return a + b + c;
    }
    function myFn2(a) { // curried function
        return function (b) {
            return function (c) {
                return a + b + c;
            }
...

{
    ...
    Person.prototype.fullName2 = () => {    // "this" is not accessible here
    ...
    console.log('Object.prototype.toString.call(person1): ', Object.prototype.toString.call(person1));  // [object Object]
    ...
    console.log('Person.prototype === person1.__proto__ === person2.__proto__: ',
        Person.prototype === person1.__proto__,
        person1.__proto__ === person2.__proto__,
        person2.__proto__ === Person.prototype);   // true true true
    ...
    console.log('Person === person1.constructor ===  person2.constructor: ',
        ...
        person2.constructor === Person);    // true true true

    console.log('person1 instanceof [Object, Function, Person]: ',
        person1 instanceof Object,
        person1 instanceof Function,
        person1 instanceof Person);  // true false true
    console.log('person1.constructor === [Object, Function, Person]: ',
        person1.constructor === Object,
        person1.constructor === Function,
        person1.constructor === Person);  // false false true
