...

{
  ...
  function fn2(fn2Param) {
    // returns undefined
    console.log('fn2Param === undefined: ', fn2Param === undefined);
  }

  console.log(
    'Is undefined a Global variable?: ',
...

{
  ...
  console.log(
    'Number.MAX_SAFE_INTEGER * Math.pow(2, 971): ',
    Number.MAX_SAFE_INTEGER * Math.pow(2, 971)
  ); // 1.7976931348623157e+308
  console.log(
    'Number.MAX_SAFE_INTEGER * Math.pow(2, 972): ',
    Number.MAX_SAFE_INTEGER * Math.pow(2, 972)
  );
...

{
  ...
  console.log(
    'Number.isNaN(function(){ return "a"; }): ',
    Number.isNaN(function () {
      return 'a';
    })
  ); // false
