...

{
  ...
  console.log(
    'Object.prototype.toString.call(arrObj): ',
    Object.prototype.toString.call(arrObj)
  ); // [object Array]
  ...
  console.log(
    'Object.prototype.toString.call(regxObj): ',
    Object.prototype.toString.call(regxObj)
  ); // [object RegExp]
  console.log('typeof Error: ', typeof Error); // function
  console.log('typeof errObj: ', typeof errObj); // object
  console.log(
    'Object.prototype.toString.call(errObj): ',
    Object.prototype.toString.call(errObj)
  ); // [object Error]
...

{
  ...
  let num = 1.23,
    str = 'John',
    bool = true; // primitive types are not instance of any class
  // let obj = new Object();
  let obj = {};
...

  {
    ...
    console.log(
      'Boolean(bool) instanceof Boolean: ',
      Boolean(bool) instanceof Boolean
    ); // false

    console.log('\nobj instanceof Object: ', obj instanceof Object); // true
    console.log(
      'numObj instanceof [Object, Number]: ',
      numObj instanceof Object,
      numObj instanceof Number
    ); // true true
    console.log(
      'strObj instanceof [Object, String]: ',
      strObj instanceof Object,
      strObj instanceof String
    ); // true true
    console.log(
      'boolObj instanceof [Object, Boolean]: ',
      boolObj instanceof Object,
      boolObj instanceof Boolean
    ); // true true
    console.log(
      'arrObj instanceof [Object, Array]: ',
      arrObj instanceof Object,
      arrObj instanceof Array
    ); // true true
    console.log(
      'dateObj instanceof [Object, Date]: ',
      dateObj instanceof Object,
      dateObj instanceof Date
    ); // true true
    console.log(
      'errObj instanceof [Object, Error]: ',
      errObj instanceof Object,
      errObj instanceof Error
    ); // true true
    console.log(
      'regxObj instanceof [Object, RegExp]: ',
      regxObj instanceof Object,
      regxObj instanceof RegExp
    ); // true true
    console.log(
      'fn instanceof [Object, Function]: ',
...

  {
    ...
    console.log(
      'Object.constructor === [Object, Function]: ',
    ...
    console.log(
      '\nnum.constructor === [Object, Number]: ',
      num.constructor === Object,
      num.constructor === Number
    ); // false true
    console.log(
      'str.constructor === [Object, String]: ',
      str.constructor === Object,
      str.constructor === String
    ); // false true
    console.log(
      'bool.constructor === [Object, Boolean]: ',
      bool.constructor === Object,
      bool.constructor === Boolean
    ); // false true
    console.log('obj.constructor === Object: ', obj.constructor === Object); // true
    console.log(
      'numObj.constructor === [Object, Number]: ',
      numObj.constructor === Object,
      numObj.constructor === Number
    ); // false true
    console.log(
      'strObj.constructor === [Object, String]: ',
      strObj.constructor === Object,
      strObj.constructor === String
    ); // false true
    console.log(
      'boolObj.constructor === [Object, Boolean]: ',
      boolObj.constructor === Object,
      boolObj.constructor === Boolean
    ); // false true
    console.log(
      'arrObj.constructor === [Object, Array]: ',
      arrObj.constructor === Object,
      arrObj.constructor === Array
    ); // false true
    console.log(
      'dateObj.constructor === [Object, Date]: ',
      dateObj.constructor === Object,
      dateObj.constructor === Date
    ); // false true
    console.log(
      'errObj.constructor === [Object, Error]: ',
      errObj.constructor === Object,
      errObj.constructor === Error
    ); // false true
    console.log(
      'regxObj.constructor === [Object, RegExp]: ',
      regxObj.constructor === Object,
      regxObj.constructor === RegExp
    ); // false true
    console.log(
      'fn.constructor === [Object, Function]: ',
